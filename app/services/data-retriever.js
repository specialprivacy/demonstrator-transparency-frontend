...
export default Service.extend({
  ...
  dataCollections: computed(function() {
    return [
  ...
  storageCollections: computed(function() {
    return [
  ...
  processingCollections: computed(function() {
    return [
  ...
  purposeCollections: computed(function() {
    return [
  ...
  recipientCollections: computed(function() {
    return [
